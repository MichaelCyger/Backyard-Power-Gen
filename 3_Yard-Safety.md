...
Gammas are stopped by dense things. Lead and thick concrete are the point of the lining. A few inches of lead and a thick concrete wall cut gammas by a huge factor. Feet of dirt on top cut them again.
...
- **Dry soil is the worse case.** Neutrons travel farther in dry sand or a drought-baked lot than in damp ground. The dose on the grass must still be a few mrem a year in that worse case. Wet years are then extra margin, not the thing you counted on.

If someone built a thin vault and counted on eight feet of damp dirt to do the real work, a dry summer or a sandy lot would show it. That is not this design. The vault is sized as if the dirt dried out.

---

## How it sits in the hole

“Five to ten feet down” means **five to ten feet of soil above the lid**, not five to ten feet to the middle of the core. The vault is about the size of a large septic tank, several feet tall. If the bottom sits at ten feet and the lid is only four feet under the grass, you do not have ten feet of dirt. The drawing has to say lid-to-grass.
...
Those pipes and cables do not come out the top, under the playset. They leave through the **bottom** of the vault, then turn and run sideways in a buried chase toward the house.

That is a real design choice, not a slogan.
...
- The chase then bends (down, over, then toward the basement or a side trench) so there is no straight shot back up to the lawn.
- The house still gets the water loop and the power lines. The connections are at the house end of the chase, where a plumber and an electrician already work.

Scatter exists. A neutron can bounce. The point of the underside chase is not magic. It is to make the easy path point into the planet, and to keep holes out of the lid. Frost, wet soil, and a path a crew can service at the house end are ordinary buried-line problems. They do not put a penetration under a child’s feet.
...
- **Do not drive playset posts at the lid.** Shallow footings or a pad on the soil. The vault is a buried tank, not a place to pin a swing.
- **Do not put the lid shallow and hope.** Lid-to-grass is five to ten feet. The playset sits on that soil, not on two feet of cover over a thin box.

The playset is allowed because the number on the grass is small, the vault does not depend on the swing set being somewhere else, and the holes that radiation likes are aimed at dirt, not at the slide.
...
If there were five to ten feet above the lid, two feet gone still leaves three to eight feet of dirt, plus the whole vault. Losing a couple of feet of soil might make the lawn number a few times higher (dirt cuts dose in layers; take away a layer and more gets through). A few times a number that was already “a few mrem, if anything” is still a small add to background, **if the vault was the real shield**.

If the vault was thin and the dirt was doing the work, two feet gone is a different story. That is why dry soil and a scoured lid are design cases, not surprises.

Flood water itself is extra shield. The risk in a flood is **scour**: dirt washed off the lid. The vault should still meet the lawn target with the lid bare, or nearly bare, sitting in a washed-out hole. Then a playset after a storm is a mud problem, not a dose problem.

If a machine hits the concrete, that person is on the cask, not on the lawn. That contact number is a crew-and-design number. It is not the playset number. A vault built to stand alone stays low there too. A vault that needed the dirt would not.
...
You would not design for a special fence, a keep-off sign, or a rule that the kids play on the other side of the driveway. If those were required, the vault is too thin or the lid is too shallow.
